        ...
        >
            ...
            >
                ...
                <div className="relative h-40 sm:h-44 w-full overflow-hidden bg-stone-50">
                    ...
                    >
                        <div className="px-2 py-0.5 bg-white/95 backdrop-blur-sm rounded-md text-[7px] font-bold uppercase tracking-wider text-[#2E7D32] shadow-sm flex items-center gap-1">
                ...
                <div className="flex-1 flex flex-col p-3 space-y-2">
                    <div className="space-y-1">
                        <p className="text-[7px] font-bold text-[#2E7D32] uppercase tracking-widest">
                            {product.category || "Fresh Harvest"}
                        </p>
                        <h3 className="font-serif text-base sm:text-lg text-[#0F2E1C] leading-tight group-hover:text-[#2E7D32] transition-colors duration-300 line-clamp-1">
                            {product.name}
                        </h3>
                    </div>
                    ...
                    {/* Description */}
                    {getDescription() && (
                        <p className="text-[10px] text-[#6D4C41] leading-relaxed opacity-60 line-clamp-1">
                            {getDescription()}
                        </p>
                    )}

                    {/* Price & Button */}
                    <div className="mt-auto pt-2 space-y-2 border-t border-stone-100">
                        <div className="flex items-baseline justify-between">
                            <div className="flex items-baseline gap-1">
                                <span className="font-serif text-xl font-bold text-[#0F2E1C]">
                                    {product.price.toFixed(0)}
                                </span>
                                <span className="text-[8px] font-bold text-[#6D4C41] uppercase">
                                    ETB
                                </span>
                            </div>
                        </div>
